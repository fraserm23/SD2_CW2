...
public class BattleCruiser extends EnemyShip {
	...
	private static final long serialVersionUID = -722443323594044006L;

	public BattleCruiser() {
		BufferedImage newImage = null;
		try {
			//gets the 'BattleCruiser' image from the images folder and adds it to the BufferedImage variable
			newImage = ImageIO.read(BattleCruiser.class.getResource("/images/BattleCruiser-resized.PNG"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		//sets the image as the BattleCruiser's ImageIcon
